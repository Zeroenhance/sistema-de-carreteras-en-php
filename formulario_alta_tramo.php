...
<div class="form"> 
<h3>Registrar tramo</h3><br>
<form action="funcion_agregar_tramo.php" method="post" id="contactFrm" name="contactFrm">
<input type="text" class="form-control" data-rule="minlen:4" required placeholder="Nombre del tramo" value="" name="nombre" class="txt"><br><br>
...
<input type="text" class="form-control" data-rule="maxlen:4" required value="" name="inicio" class="txt"><br><br>
<div align="left">Kilometro de fin:</div>
<input type="text" class="form-control" data-rule="maxlen:4" required value="" name="fin" class="txt"><br><br>
<input type="submit" value="Registrar tramo" name="submit" class="txt2">
</form>
</div>
</div>
</div>
